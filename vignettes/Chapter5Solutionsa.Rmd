...
```{r fig5.1-2, fig.width=8, fig.height=3}
sigma=1.2
n=20
nDegree=8
...
```{r subsetsim, fig.width=8, fig.height=4}
library(mvtnorm)
...
# Code for Figure 5.5
```{r fig5.5, fig.width=8, fig.height=3}
...
```{r headbobs, fig.width=8, fig.height=4}
data(headbobLizards)
str(headbobLizards)
...
```{r ex5.5plantprecip, fig.width=8, fig.height=4}
data(globalPlants)
str(globalPlants)
