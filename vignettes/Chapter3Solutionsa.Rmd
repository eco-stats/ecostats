...
```{r ex3.2heightRainLat, fig.width=8, fig.height=4}
...
```{r ex3.3logRain, fig.width=8, fig.height=4}
 par(mfrow=c(1,2),mar=c(3,3,1,1),mgp=c(1.75,0.75,0))
...
```{r ex3.5logClimate, fig.width=8, fig.height=4}
 par(mfrow=c(1,2),mar=c(3,3,1,1),mgp=c(1.75,0.75,0))
 globalPlants$logRain = log(globalPlants$rain)
 globalPlants$logHt = log(globalPlants$height)
...
```{r ex3.6seaweedbox, fig.width=5, fig.height=5}
...
```{r ex3.6seaweedlogreplot, fig.width=8, fig.height=4}
...
```{r ex3.6seaweedlogre, fig.width=8, fig.height=4}
 par(mfrow=c(1,2),mar=c(3,3,1,1),mgp=c(1.75,0.75,0))
...
```{r ex3.7seaweedSMALL, fig.width=4, fig.height=4}
